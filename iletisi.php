...
<body class="text-white">
    ...
    <header class="px-4 flex justify-between items-stretch bg-blue-900 relative h-24">
        ...
        <nav class="space-x-1 hidden md:flex items-stretch">
            <a href="https://akinsoftadana.com.tr/" class="menu-link px-4 flex items-center hover:text-yellow-300 transition-all duration-300 h-full">
                <i class="fas fa-home mr-2"></i>Ansayfa
            ...
            <a href="/hizmetler.php" class="menu-link px-4 flex items-center hover:text-yellow-300 transition-all duration-300 h-full">
              ...
              <a href="/hakkimizde.php" class="menu-link px-4 flex items-center hover:text-yellow-300 transition-all duration-300 h-full">
                <i class="fas fa-envelope mr-2"></i>Hakkımıkzda
                <span class="bottom-border"></span>
            </a>
        </nav>
         
        </nav>
        <button class="mobile-menu-button text-white text-2xl btn-raised rounded-lg p-2 md:hidden self-center" onclick="toggleMobileMenu()">
            <i class="fas fa-bars"></i>
        </button>
        <div class="mobile-menu-content md:hidden">
            <a href="/index.php" class="mobile-menu-link"><i class="fas fa-home mr-2"></i>Anasayfa</a>
            ...
            <a href="/hakkimizde.php" class="mobile-menu-link"><i class="fas fa-cogs mr-2"></i>Hakkımızda</a>
...
<section class="py-20 px-6 bg-indigo-600" id="iletisim">
  
    <div class="max-w-4xl mx-auto bg-indigo-500 p-10 rounded-2xl shadow-lg" data-aos="fade-up">

        <h2 class="text-3xl font-bold mb-4 text-yellow-300">İletişim <img src="/Resimler/as-by-yatay.png" align="right" width="400PX" height="90"></h2>
        <h2 class="text-3xl font-bold mb-4 text-white">Yağmur Bilgisayar </h2>
        <h2 class="text-2xl font-bold mb-4 text-white">* Akınsoft Adana Resmi Yetkilisi</h2>
        <p class="mb-2 text-white">Adres: Sümer Mah. Karafatma Cad. No:124/A Seyhan / ADANA</p>
        <p class="mb-2 text-white">GSM: 0 505 455 29 46 / Tel: 0 322 226 36 14</p>
        <p class="mb-6 text-white">Email: <a href="mailto:yagmurbilgisayaradana@hotmail.com" class="underline hover:text-yellow-300">yagmurbilgisayaradana@hotmail.com</a></p>
        
        <div class="flex justify-center space-x-6 mb-6">
        <a href="https://www.facebook.com/share_channel/#" target="_blank" class="text-blue-300 text-4xl hover:text-blue-500 btn-raised p-2 rounded-full"><i class="fab fa-facebook"></i></a>
        <a href="https://instagram.com/yagmurbilgisayaradana" target="_blank" class="text-pink-300 text-4xl hover:text-pink-500 btn-raised p-2 rounded-full"><i class="fab fa-instagram"></i></a>
        <a href="https://wa.me/905054552946" target="_blank" class="text-green-400 text-4xl hover:text-green-500 btn-raised p-2 rounded-full"><i class=" fab fa-whatsapp"></i></a>
      </div>
        
        <div>
            <iframe src="https://maps.google.com/maps?q=Sümer%20Mah.%20Karafatma%20Cad.%20No:124%2FA%20Seyhan%2FAdana&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        
        <div class="mt-6 text-center">
            <a href="https://g.page/r/Cet0Aav2frcWEAE/review" target="_blank" class="inline-block bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-full btn-raised transition">
    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="mb-8">
       ...
       <div class="grid grid-cols-1 md:grid-cols-5 gap-12">
        ...
        <div class="md:col-span-4" data-aos="fade-up"> <div id="firsat-banner-container" class="mb-8">
                    </div>
                ...
                </div> </div> </section><div class="grid grid-cols-1 md:grid-cols-5 gap-12">
        ...
        <div class="bg-gray-800 p-4 rounded-lg">
            <h4 class="text-yellow-400 font-semibold mb-3">MEDYA MERKEZİ</h4>
          <ul class="space-y-2 text-sm">
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Basın Bültenleri</a></li>
            <li><a href="#" class="hover:text-yellow-300 transition-colors">INOVAX</a></li>
            <li><a href="#" class="hover:text-yellow-300 transition-colors">AKINSOFT Video</a></li>
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Program Haberleri</a></li>
          </ul>
        </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg">
          ...
          <ul class="space-y-2 text-sm">
            <li><a href="#" class="hover:text-yellow-300 transition-colors">İş Başvuru</a></li>
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Staj Uygulaması</a></li>
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Burs Başvurusu</a></li>
            ...
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Statüler</a></li>
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Liza Çiçeği</a></li>
          </ul>
        </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg">
          ...
          <ul class="space-y-2 text-sm">
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Lisans Sistemi</a></li>
            ...
            <li><a href="#" class="hover:text-yellow-300 transition-colors">Haklı Kullanıcı Platformu</a></li>
