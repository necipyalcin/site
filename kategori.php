...
<body class="text-white">
    ...
    <button id="mobileMenuBtn" class="p-2 border rounded md:hidden">
        <i class="fas fa-bars mr-2"></i> Kategoriler
    </button>
</div>
    ...
    <section class="py-2 px-1 relative overflow-hidden" data-aos="fade-up">
        <div class="container mx-auto flex flex-col md:flex-row items-start md:items-center gap-6">
            <div class="filter-panel flex flex-wrap items-center gap-2 p-2 bg-white shadow-sm rounded-2xl border border-blue-100 md:max-w-xs">
                <div class="flex-1 w-full sm:w-auto min-w-[120px] relative">
                ...
                <div class="w-full sm:w-auto min-w-[120px]">
                    <select id="productSort" class="w-full h-8 px-2 rounded-lg border border-blue-300 focus:ring-1 focus:ring-blue-400 focus:border-blue-400 outline-none text-gray-700 text-sm">
        ...
        <div class="lottie-container" style="transform: translateX(3cm);">
            <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_bdlrkrqv.json" background="transparent" speed="1" style="width: 80%; height: 140%;" loop autoplay>
            </lottie-player>
        </div>
    </section>

    <section class="py-0 px-1 bg-gradient-to-r from-blue-900 to-blue-800" id="urunler">
        <div class="max-w-7xl mx-auto py-8">
            
            <div class="grid grid-cols-1 md:grid-cols-5 gap-12">

                <div id="category-column" class="md:col-span-1" data-aos="fade-right">
    ...
    <div class="flex justify-between items-center p-4 border-b">
        ...
        <button id="closeMobileMenuBtn" class="text-2xl">&times;</button>
    </div>
